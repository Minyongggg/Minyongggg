...
### 📌 Organization
`2021.03 ~ 2022.02` 고려대학교 소프트웨어벤처 학회 멋쟁이사자처럼 9기 학회원
<br>
`2022.03 ~ 08` 고려대학교 소프트웨어벤처 학회 멋쟁이사자처럼 10기 운영진
<br>
`2022.01 ~ 07` (주)바카티오 Backend Engineer

### 📌 Project
`2021.05 ~ 06` 독강러 매칭 플랫폼 Codok 기획・개발 (고려대학교 멋쟁이사자처럼 해커톤 1위)
<br>
`2021.06 ~ 07` 한・미・일 출산율과 사회경제적 요인 간 상관관계 비교 데이터 분석 연구
<br>
`2022.01 ~ 07` 개인 맞춤형 여행 컨시어지 서비스, 하우 개발 (現 감성숙소 큐레이션, 하우)
<br>
`2022.09 ~ 10` 테니스 선수 플레이 유형별 데이터 분석 연구
<br>
`2023.07 ~ ` 생성형 AI 기반 연애상담 솔루션 Heartee 기획・개발
